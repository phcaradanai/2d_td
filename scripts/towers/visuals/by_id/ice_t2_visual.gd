...
# Tower: Ice Tower 2
# Role: Ice prism — slows and chains cold damage
# Elements: light, water
# Visual source: tier fallback wrapper → by_id/ice_t1_visual.gd
# Tier 2 intentionally reuses the tier 1 premium model until a dedicated T2 silhouette is produced.

const _Fallback = preload("res://scripts/towers/visuals/by_id/ice_t1_visual.gd")
