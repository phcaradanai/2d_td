...
# Role: Neutral AoE splash projectile
# Elements: None
# Visual source: wrapper → fallback/cannon_tower_visual.gd
# TODO: Replace fallback wrapper with a custom silhouette that communicates role.

const _Fallback = preload("res://scripts/towers/visuals/fallback/cannon_tower_visual.gd")
