...
# Tower: Flamethrower Tower 3
# Role: Cone fire — continuous flame projection
# Elements: darkness, fire, earth
# Visual source: tier fallback wrapper → by_id/flamethrower_t1_visual.gd
# Tier 3 intentionally reuses the tier 1 premium model until a dedicated T3 silhouette is produced.

const _Fallback = preload("res://scripts/towers/visuals/by_id/flamethrower_t1_visual.gd")
