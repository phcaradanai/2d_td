...
# Tower: Mushroom Tower 2
# Role: Spore cap — spreading spore cloud
# Elements: nature, earth
# Visual source: tier fallback wrapper → by_id/mushroom_t1_visual.gd
# Tier 2 intentionally reuses the tier 1 premium model until a dedicated T2 silhouette is produced.

const _Fallback = preload("res://scripts/towers/visuals/by_id/mushroom_t1_visual.gd")
