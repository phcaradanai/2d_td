...
# Tower: Tidal Tower 2
# Role: Tidal surge — pushes and drowns in waves
# Elements: light, water, nature
# Visual source: tier fallback wrapper → by_id/tidal_t1_visual.gd
# Tier 2 intentionally reuses the tier 1 premium model until a dedicated T2 silhouette is produced.

const _Fallback = preload("res://scripts/towers/visuals/by_id/tidal_t1_visual.gd")
