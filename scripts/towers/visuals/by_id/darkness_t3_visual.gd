...
# Tower: Darkness Tower III
# Role: Void energy drain projectile
# Elements: darkness
# Visual source: tier fallback wrapper → by_id/darkness_t1_visual.gd
# Tier 3 intentionally reuses the tier 1 premium model until a dedicated T3 silhouette is produced.

const _Fallback = preload("res://scripts/towers/visuals/by_id/darkness_t1_visual.gd")
