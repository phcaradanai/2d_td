...
# Tower: Polar Tower 2
# Role: Polar ice — extreme slow and freeze
# Elements: light, water, earth
# Visual source: tier fallback wrapper → by_id/polar_t1_visual.gd
# Tier 2 intentionally reuses the tier 1 premium model until a dedicated T2 silhouette is produced.

const _Fallback = preload("res://scripts/towers/visuals/by_id/polar_t1_visual.gd")
