...
# Tower: Corrosion Tower 2
# Role: Acid DoT — melts armor over time
# Elements: darkness, water, fire
# Visual source: tier fallback wrapper → by_id/corrosion_t1_visual.gd
# Tier 2 intentionally reuses the tier 1 premium model until a dedicated T2 silhouette is produced.

const _Fallback = preload("res://scripts/towers/visuals/by_id/corrosion_t1_visual.gd")
