...
# Tower: Nature Tower III
# Role: Bio-vine tangle trap
# Elements: nature
# Visual source: tier fallback wrapper → by_id/nature_t1_visual.gd
# Tier 3 intentionally reuses the tier 1 premium model until a dedicated T3 silhouette is produced.

const _Fallback = preload("res://scripts/towers/visuals/by_id/nature_t1_visual.gd")
