...
# Tower: Trickery Tower 2
# Role: Illusion — creates decoys and confuses targeting
# Elements: light, darkness
# Visual source: tier fallback wrapper → by_id/trickery_t1_visual.gd
# Tier 2 intentionally reuses the tier 1 premium model until a dedicated T2 silhouette is produced.

const _Fallback = preload("res://scripts/towers/visuals/by_id/trickery_t1_visual.gd")
