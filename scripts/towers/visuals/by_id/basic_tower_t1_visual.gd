...
# Role: Starter all-purpose ranged attack
# Elements: None
# Visual source: wrapper → fallback/basic_tower_visual.gd
# TODO: Replace fallback wrapper with a custom silhouette that communicates role.

const _Fallback = preload("res://scripts/towers/visuals/fallback/basic_tower_visual.gd")
