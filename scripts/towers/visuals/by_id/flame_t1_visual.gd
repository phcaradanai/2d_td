...
# Tower: Flame Tower 1
# Role: Wildfire — spreading AoE burn
# Elements: fire, nature
# Visual source: wrapper → fallback/ember_bloom_tower_visual.gd
# TODO: Replace fallback wrapper with a custom silhouette that communicates role.

const _Fallback = preload("res://scripts/towers/visuals/fallback/ember_bloom_tower_visual.gd")
