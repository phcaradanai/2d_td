...
# Tower: Magic Tower 2
# Role: Chaos orb — random elemental damage
# Elements: darkness, fire
# Visual source: wrapper → fallback/chaos_orb_tower_visual.gd
# TODO: Replace fallback wrapper with a custom silhouette that communicates role.

const _Fallback = preload("res://scripts/towers/visuals/fallback/chaos_orb_tower_visual.gd")
